...
namespace TheDogHouse.Busquedas
{
    public partial class FrmBusquedaCargo : Form
    {
        ...
        void cargardg()
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand($"SELECT * FROM Cargo WHERE Codigo LIKE '%{TxtFiltro.Text}%'", con);
        ...
        {
            int i = DgCargo.CurrentRow.Index;
            DgCargo.Rows[i].Selected = true;
        }
